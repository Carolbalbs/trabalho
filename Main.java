...
public class Main {
	...
	public static void main(String[] args) {
		...
		Sistema sistema = Fabrica.criarEntrada();
		Biblioteca biblioteca = Fabrica.criarBiblioteca();
		String entradaCompleta = null;
		String cmd = null;
		Parametros parametros = Fabrica.criarParametros();
		
		AlunoGrad aluno1 = Fabrica.criarAlunoGraduacao("123", "João da Silva");
		AlunoPosGrad aluno2 = Fabrica.criarAlunoPosGraduacao("456", "Luiz Fernando Rodrigues");
		AlunoGrad aluno3 = Fabrica.criarAlunoGraduacao("789", "Pedro Paulo");
		...
		while (rodar != 1) {
			...
			cmd = SplitString.separarStrings(parametros, entradaCompleta);
			
			try {
				sistema.executarComando(cmd, parametros);
			...
			cmd = null;
			parametros.setCodigoUm(null);
			parametros.setCodigoDois(null);
			valido = false;
		}
