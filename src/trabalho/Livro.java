...
public class Livro {
	...
	public Livro(String idLivro, String titulo, String editora, List<String> autores, int edicao, int anoPublicacao,
	...
	public Livro(String idLivro, String titulo, String editora, List<String> autores, int edicao,
			int anoPublicacao) {
		super();
		this.IDLivro = idLivro;
		this.titulo = titulo;
