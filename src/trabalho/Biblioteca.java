...
public class Biblioteca {
	...
	public Usuario consultarNotificacao(String codigoUsuario){
	...
	public Livro consultarUsuarioApto(String codigoUsuario) {
		Usuario usuario = this.buscarUsuarioPorCodigo(codigoUsuario);
	...
	public void reservarLivro(String codigoLivro, String codigoUsuario) {
		Usuario usuario = this.buscarUsuarioPorCodigo(codigoUsuario);
        Livro livro =  this.buscarLivroPorCodigo(codigoLivro);
	...
	public void registrarObservador(String codigoLivro, String codigoUsuario) {
		Usuario usuario = this.buscarUsuarioPorCodigo(codigoUsuario);
        Livro livro =  this.buscarLivroPorCodigo(codigoLivro);
